...
const columns: ColumnDef[] = [
  ...
  { key: "name", label: "模块名称", minWidth: "140px", placeholder: "战略解码营" },
  { key: "topic", label: "核心主题", minWidth: "140px", placeholder: "战略理解与承接" },
  { key: "objective", label: "教学目标", type: "textarea", minWidth: "200px", placeholder: "学员能够..." },
  { key: "outline", label: "课程大纲", type: "textarea", minWidth: "220px", placeholder: "1. 模块概述\n2. 核心内容\n3. 实践环节\n4. 总结复盘" },
  { key: "method", label: "主要教学方法", minWidth: "120px", placeholder: "工作坊+共创" },
  ...
  { key: "businessAlign", label: "业务对齐", type: "textarea", minWidth: "150px", placeholder: "对齐任务..." },
];

const moduleTemplates = [
  { code: "LJ-00", name: "战略解码营", topic: "战略理解与承接", objective: "学员能将公司战略解码为部门SMART行动计划", outline: "1. 公司战略解读\n2. 战略解码工具\n3. 部门行动计划研讨\n4. 成果路演", method: "工作坊+共创", format: "现场", hours: 2, facilitatorType: "混合", competency: "C", businessAlign: "" },
  { code: "LJ-01", name: "领导力认知", topic: "角色转型与自我认知", objective: "理解管理者角色定位和领导力发展路径", outline: "1. 管理者角色定位\n2. 领导力测评反馈\n3. 个人发展计划", method: "测评+反馈+工作坊", format: "现场", hours: 4, facilitatorType: "外部顾问", competency: "A", businessAlign: "" },
  { code: "LJ-02", name: "团队管理实战", topic: "团队建设与绩效管理", objective: "掌握团队诊断和绩效辅导的方法", outline: "1. 团队发展阶段\n2. 绩效对话练习\n3. 情境领导力\n4. 实战模拟", method: "情境模拟+角色扮演", format: "现场", hours: 4, facilitatorType: "外部顾问", competency: "C", businessAlign: "" },
];
