...
const columns: ColumnDef[] = [
  ...
  { key: "name", label: "环节名称", placeholder: "开营破冰" },
  { key: "objective", label: "教学目标", width: "180px", placeholder: "建立学习共同体" },
  { key: "activity", label: "活动描述", width: "220px", placeholder: "详细描述活动..." },
  { key: "facilitator", label: "促进者要点", width: "150px", placeholder: "关键指导..." },
  { key: "materials", label: "所需材料", placeholder: "白板·马克笔" },
  { key: "assessment", label: "即时评估", placeholder: "手势投票" },
];
